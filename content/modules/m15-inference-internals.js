  ...
  lessons: [
    ...
    },
    {
      ...
      html: '<h2>What the cache holds and the formula</h2>' +
        ...
        '</ul>' +
        '<p>Orthogonal levers stack with these: <b>sliding-window layers</b> (Mistral, Gemma interleave layers that only attend to the last 4–8k tokens — cache for those layers stops growing), <b>KV cache quantization</b> to FP8/INT4 (lesson 4), and <b>prefix caching</b> — reusing the cache of a shared prompt prefix across requests, which is what providers\' "cached input" pricing literally bills for.</p>' +
